/**
 * student-master-sp-regdate-2026-04-29.sql
 *
 * Ku dar `reg_date_sp date` halbeegga student_master_sp (ka hor `oper`),
 * si form-ku u qaado taariikhda diiwaangelinta cusub. Hadduu reg_date_sp
 * la siiyo NULL ama maro maran, SP-gu wuxuu isticmaalayaa now() (dabeecaddii
 * hore). Wax kale lama bedelin — INSERT/UPDATE/DELETE shaqo ahaan isku mid.
 */
...
BEGIN
    ...
    -- Hadduu reg_date_sp NULL yahay ama la siiyo qiime aan jirin, isticmaal now().
