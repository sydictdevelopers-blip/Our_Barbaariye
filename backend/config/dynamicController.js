...
const PROCEDURE_PARAM_ORDER = {
  ...
  academic_year_sp: ['a_y_id_sp', 'academic_name_sp', 'started_sp', 'ended_sp', 'u_br_id_sp', 'oper'],
  ...
  // SQL: update_one_exam_assign_class_state(p_er_id, br_id, p_state) → "Result" varchar
  update_one_exam_assign_class_state: ['p_er_id_sp', 'br_id_sp', 'p_state_sp'],
