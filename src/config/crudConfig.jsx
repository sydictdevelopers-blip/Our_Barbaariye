...
const ENTITIES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'state_sp', label: 'State', type: 'select', required: true, rowKey: 'state', param: 'state_sp', options: [{ value: 'Active', label: 'Active' }, { value: 'Inactive', label: 'Inactive' }], default: 'Active' },
      { name: 'u_br_id_sp', type: 'hidden', param: 'u_br_id_sp', default: getSessionUBrId },
    ],
  },
  {
