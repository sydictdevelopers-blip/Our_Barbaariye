      ...
      <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full ps-9 pe-9 py-2 text-sm rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0f3d5e]/30 focus:border-[#0f3d5e]/50 transition"
          />
          {search && (
            <button
              type="button"
        ...
        {loading ? (
          ...
          <table className="w-full text-sm">
            <thead className="bg-[#0f3d5e] text-white">
              <tr>
                <th className="text-start px-4 py-3 w-20 font-semibold">{t('responsiblesPanel.cols.id')}</th>
                <th className="text-start px-4 py-3 font-semibold">{t('responsiblesPanel.cols.name')}</th>
                <th className="text-start px-4 py-3 w-56 font-semibold">{t('responsiblesPanel.cols.phoneOne')}</th>
                <th className="text-start px-4 py-3 w-56 font-semibold">{t('responsiblesPanel.cols.phoneTwo')}</th>
              </tr>
            </thead>
            <tbody>
              {visibleRows.map((r) => {
