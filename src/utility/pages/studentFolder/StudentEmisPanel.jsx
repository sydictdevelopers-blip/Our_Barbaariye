        ...
        {loading ? (
          ...
          <table className="w-full text-sm">
            <thead className="bg-[#0f3d5e] text-white sticky top-0 z-10">
              <tr>
                <th className="text-start px-4 py-3 w-20 font-semibold">{t('emisPanel.cols.id')}</th>
                <th className="text-start px-4 py-3 w-80 font-semibold">{t('emisPanel.cols.idCard')}</th>
                <th className="text-start px-4 py-3 font-semibold">{t('emisPanel.cols.student')}</th>
              </tr>
            </thead>
            <tbody>
              {visibleRows.map((r) => {
